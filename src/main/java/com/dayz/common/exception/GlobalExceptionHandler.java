...
public class GlobalExceptionHandler {
    ...
    public CommonApiResponse handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public CommonApiResponse<?> handleBusinessExceptionException(BusinessException ex) {
        log.error("{}", ex);
