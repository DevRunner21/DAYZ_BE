...
public class ReadReviewsByMemberResponse extends CustomPageResponse<ReadReviewsByMemberResponse.ReviewResult> {
    ...
    @ApiModel(value = "ReadReviewsByMemberResponse.ReviewResult")
    @Getter
    @Setter(AccessLevel.PRIVATE)
    @NoArgsConstructor
    public static class ReviewResult {
        ...
        private ReadReviewsByMemberResponse.ReviewResult.MemberResult member;

        @ApiModelProperty(value = "원데이클래스 정보", dataType = "object")
        private ReadReviewsByMemberResponse.ReviewResult.OneDayClassResult oneDayClass;

        @ApiModelProperty(value = "리뷰 이미지 목록", dataType = "array")
        private List<ReadReviewsByMemberResponse.ReviewResult.ReviewImageResult> reviewImages;
        ...
        public static ReviewResult of(
            ...
            ReadReviewsByMemberResponse.ReviewResult.MemberResult member,
            OneDayClassResult oneDayClass,
            List<ReadReviewsByMemberResponse.ReviewResult.ReviewImageResult> reviewImages
        ) {
        ...
        @ApiModel(value = "ReadReviewsByMemberResponse.ReviewResult.MemberResult")
        @Getter
        @Setter(AccessLevel.PRIVATE)
        ...
        @ApiModel(value = "ReadReviewsByMemberResponse.ReviewResult.OneDayClassResult")
        @Getter
        @Setter(AccessLevel.PRIVATE)
        ...
        @ApiModel(value = "ReadReviewsByMemberResponse.ReviewResult.ReviewImageResult")
        @Getter
        @Setter(AccessLevel.PRIVATE)
