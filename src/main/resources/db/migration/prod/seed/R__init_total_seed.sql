...
## 원데이 클래스 시간
INSERT IGNORE INTO  onedayclass_time (onedayclass_time_id, class_date, start_time, end_time, status, onedayclass_id, use_flag, created_at, updated_at)
...
## 원데이 클래스 이미지
INSERT IGNORE INTO  onedayclass_iamge (image_file_name, sequence, onedayclass_id, use_flag, created_at, updated_at)
...
## 커리큘럼
INSERT IGNORE INTO  curriculum (step, content, onedayclass_id, use_flag, created_at, updated_at)
...
## 리뷰
INSERT IGNORE INTO  review (content, score, member_id, onedayclass_id, use_flag, created_at, updated_at)
...
## 게시글
INSERT IGNORE INTO  post (post_id, content, member_id, onedayclass_id, use_flag, created_at, updated_at)
